                    ...
                    if($customer_id==""){
                        ...
                        if($query_run){
                            ...
                            if(mysqli_num_rows($query_run)>0)
							{
                                ...
                                $row = mysqli_fetch_array($query_run,MYSQLI_ASSOC);
                                echo '<tr><td>', $row["payment_id"] . '</td><td>' . $row["customer_id"] .  '</td><td>' . $row["staff_id"] . '</td><td>' . $row["rental_id"] . '</td><td>' . $row["amount"] . '</td><td>' . $row["payment_date"] . '</td><td>' . $row["last_update"] . '</td><td>';
                                $loops++;
                                }
							}
							else{
