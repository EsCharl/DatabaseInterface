...
\section{Normalization}
	...
	\subsection{Insertion After Normalization}
		...
		\begin{figure}[H]
			...
			\includegraphics[width=\textwidth]{specialfeatures2_insert_norm}
	...
	\subsection{Deletion After Normalization}
		...
		\begin{figure}[H]
			\includegraphics[width=\textwidth]{address1_delete_norm}
			\includegraphics[width=\textwidth]{address2_delete_norm}
